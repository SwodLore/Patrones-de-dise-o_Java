...
public class VistaPrincipal extends CustomComponent implements Observador {  
  ...
  public VistaPrincipal(BaseVehiculos modelo) {  
    ...
    modelo.agrega(this);  
    menuSeleccion.addListener(new ControladorMenuSeleccion(modelo));  
    botonAnuncioSiguiente.addListener(new ControladorBotonAnuncioSiguiente(modelo, this));  
    actualiza();  
  } 
  ...
  private AbsoluteLayout buildMainLayout() {  
    ...
    mainLayout.addComponent(labelMarca, "top:140.0px;left:49.0px;");  
    // labelModelo  
    ...
    mainLayout.addComponent(labelModelo, "top:180.0px;left:49.0px;");  
    // labelPrecio  
    ...
    mainLayout.addComponent(labelPrecio, "top:220.0px;left:49.0px;");  
    // campoAnuncio  
    campoAnuncio = new Label();  
    campoAnuncio.setWidth("331px");  
    campoAnuncio.setHeight("140px");  
    mainLayout.addComponent(campoAnuncio, "top:320.0px;left:49.0px;");  
    // campoMarca  
    campoMarca = new Label();  
    campoMarca.setWidth("240px");  
    campoMarca.setHeight("-1px");  
    mainLayout.addComponent(campoMarca, "top:134.0px;left:140.0px;");  
    // campoModelo  
    campoModelo = new Label();  
    campoModelo.setWidth("240px");  
    campoModelo.setHeight("-1px");  
    mainLayout.addComponent(campoModelo, "top:174.0px;left:140.0px;");  
    // campoPrecio  
    campoPrecio = new Label();  
    campoPrecio.setWidth("240px");  
    campoPrecio.setHeight("-1px");  
    mainLayout.addComponent(campoPrecio, "top:216.0px;left:140.0px;");  
    ...
    mainLayout.addComponent(botonAnuncioSiguiente, "top:262.0px;left:140.0px;");  
    // menuSeleccion  
    ...
    mainLayout.addComponent(menuSeleccion, "top:60.0px;left:140.0px;");  
    return mainLayout;  
  }  

  public void actualiza() {  
    menuSeleccion.removeAllItems();  
    List<BaseVehiculos.VehiculoDescripcion> listaVehiculos = modelo.getListaVehiculos();  
    int indiceVehiculoEnCurso = modelo.getIndiceVehiculoEnCurso();  
    for (BaseVehiculos.VehiculoDescripcion descripcion : listaVehiculos) {  
